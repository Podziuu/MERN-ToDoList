...
const Dropdown = React.forwardRef(
  ({ category, setCategory, errors, setCategoryError, ...rest }, ref) => {
    ...
    return (
      <div className="flex flex-col gap-y-2 relative">
        ...
        >
          <h4 className={`${category === "Category" ? "" : "text-white"}`}>
            {category}
          </h4>
          <svg
            fill="#9CA3AF"
	...
	s7.794-1.581,10.606-4.394l149.996-150C331.465,94.749,331.465,85.251,325.607,79.393z"
        ...
        {errors && <span className="ml-4 pt-1 text-red-500">{errors}</span>}
        <AnimatePresence>
          {isMenu && (
            <motion.div
            ...
            >
              <ul className="gap-y-1 flex flex-col" {...rest} ref={ref}>
